...
def home(request):
    ...
    room_messages = Message.objects.filter(Q(room__topic__name__icontains=q)) # get all messages, det er her jeg kan endre recent activities til f.eks hvem amn følger osv. 
...
def userProfile(request, pk):
    ...
    profile = getattr(user, 'profile', None)  # Henter Profile hvis den finnes
